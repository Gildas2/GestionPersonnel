                          ...
                          <div class="chat-bubble">
                            ...
                            <div class="chat-action-btns">
                              <ul>
                                ...
                                <li>
                                  <a href="chat.html#" class="edit-msg"
                                    ><i class="fa-solid fa-pencil"></i
                                  ></a>
                                </li>
                                <li>
                                  <a href="chat.html#" class="del-msg"
                          ...
                          <div class="chat-bubble">
                            <div class="chat-content img-content">
                              <div class="chat-img-group clearfix">
                                ...
                                <a class="chat-img-attach" href="chat.html#">
                                  <img
                                    width="182"
                                    height="137"
                            ...
                            <div class="chat-content">
                              ...
                              <ul class="attach-list">
                                <li>
                                  ...
                                  <a href="chat.html#">example.avi</a>
                                </li>
                                <li>
                                  <i class="fa fa-file"></i>
                                  <a href="chat.html#">activity.psd</a>
                                </li>
                                <li>
                                  <i class="fa fa-file"></i>
                                  <a href="chat.html#">example.psd</a>
                                </li>
                              </ul>
                            </div>
                            <div class="chat-action-btns">
                            ...
                            <div class="chat-content">
                              <ul class="attach-list">
                                <li class="pdf-file">
                                  ...
                                  <a href="chat.html#">Document_2016.pdf</a>
                                </li>
                              </ul>
                              <span class="chat-time">9:00 am</span>
                            </div>
                            ...
                            <li>
                              ...
                              <span class="float-end text-muted"
                                ><a
                                  ...
                                  class="__cf_email__"
                                  data-cfemail="610b0e090f050e04210419000c110d044f020e0c"
                                  >[email&#160;protected]</a
                                ></span
                              >
                            </li>
                                ...
                                <li>
                                  <div class="files-cont">
                                    ...
                                    <div class="files-info">
                                      ...
                                      >
                                      <span class="file-author"
                                        ><a href="chat.html#">John Doe</a></span
                                      >
                                      <span class="file-date"
                                        >May 31st at 6:53 PM</span
                                      >
              ...
              <ul class="upload-list">
                <li class="file-list">
                  ...
                  <div class="progress progress-xs progress-striped">
                    <div
                      class="progress-bar bg-success w-65"
                      role="progressbar"
                    ></div>
                  </div>
            ...
            <div class="files-share-list">
              <div class="files-cont">
                ...
                <div class="files-info">
                  ...
                  >
                  <span class="file-author"
                    ><a href="chat.html#">Bernardo Galaviz</a></span
                  >
