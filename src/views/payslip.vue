          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div>
                    <h4 class="m-b-10"><strong>Les revenus</strong></h4>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            ...
                            <span class="float-end"><strong>$55</strong></span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="col-sm-6">
                  <div>
                    <h4 class="m-b-10"><strong>Les Déductions</strong></h4>
                    <table class="table table-bordered">
                      <tbody>
                        <tr>
                          <td>
